...
DefinitionBlock ("", "SSDT", 2, "hack", "XOSI", 0x00000000)
{
    ...
    External (W98S, FieldUnitObj)
    External (NT5S, FieldUnitObj)
    External (WINM, FieldUnitObj)
    External (WXP, FieldUnitObj)
    External (WLG, FieldUnitObj)
    External (WIN7, FieldUnitObj)
    External (WIN8, FieldUnitObj)
    External (WN81, FieldUnitObj)
    External (LINX, FieldUnitObj)
